...
import numpy as np
from index_requester import IndexRequester, DummyIndexRequester

logging.basicConfig(level=logging.INFO)

class ImageProcessor(object):
    def __init__(self, aligned_img_folder='../tmp/', aligned_img_size=160, pretrained_model='../pretrained_model'):
        ...
        # index service
        self._index_requester = DummyIndexRequester()
    ...
    def align_image(self, img_filepath):
        ...
        aligned_img_path = os.path.join(self._aligned_img_folder, img_name)
        ...
        cv2.imwrite(aligned_img_path[:-3]+self._aligned_img_ext, aligned_img)
    ...
    def get_best_matches_imgs(self, img_filepath, count=1):
        ...
        best_matches_img_names = get_best_matches_img_names(embedding, count)
