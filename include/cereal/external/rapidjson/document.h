...
struct TypeHelper<ValueType, const typename ValueType::Ch *> {
    ...
    static ValueType &
    Set(ValueType &v, const StringType data, typename ValueType::AllocatorType &a) { return v.SetString(data, a); }
};
...
public:
    ...
    */
     ...
     */
    template<typename T>
    CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::IsGenericValue<T>), (bool)) operator!=(const T &rhs) const {
        return !(*this == rhs);
    }
